...
# SQL Evaluation Library - Project Setup Script
# This script sets up the project environment including submodules and dependencies

set -e  # Exit on any error

echo "🚀 Setting up SQL Evaluation Library Project"
echo "=============================================="
...
if [ ! -f "pyproject.toml" ]; then
    print_error "Error: pyproject.toml not found. Please run this script from the sql_evaluation_library directory."
    exit 1
fi
